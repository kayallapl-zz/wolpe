...
define('WONDERPLUGIN_VIDEOEMBED_VERSION', '1.6');
...
define('WONDERPLUGIN_VIDEOEMBED_PLUGIN_VERSION', '1.6');
...
class WonderPlugin_Videoembed_Plugin {
	...
	function enqueue_admin_creator_script($hook)
	{
		...
		wp_localize_script('jquery', 'WONDERPLUGIN_VIDEO_MCE_EDITOR', array(
