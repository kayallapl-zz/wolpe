...
function tdmacro_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		...
		<div class="nav-links">
			<?php previous_post_link( '<div class="nav-previous">%link</div>', '<span class="meta-title">'.__( 'Texto anterior', 'tdmacro' ).'</span> %title' ); ?>
			<?php next_post_link( '<div class="nav-next">%link</div>', '<span class="meta-title">'.__( 'Próximo texto', 'tdmacro' ).'</span> %title' ); ?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
}
