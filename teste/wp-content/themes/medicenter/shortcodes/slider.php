		...
		if(!empty($slider_options["slider_height"]) && $slider_options["slider_height"]!=670) {
			...
			$output .= '
				.slider li { 
					...
					background-size: auto ' . $slider_styles["height"][0] . 'px;
					-moz-background-size: auto ' . $slider_styles["height"][0] . 'px;
					-webkit-background-size: auto ' . $slider_styles["height"][0] . 'px;
					-o-background-size: auto ' . $slider_styles["height"][0] . 'px;
				}
				.slider_content_box
				{
				...
				@media screen and (max-width: 1009px) {
					.slider li { 
						...
						background-size: auto ' . $slider_styles["height"][1] . 'px;
						-moz-background-size: auto ' . $slider_styles["height"][1] . 'px;
						-webkit-background-size: auto ' . $slider_styles["height"][1] . 'px;
						-o-background-size: auto ' . $slider_styles["height"][1] . 'px;
					}
					.slider_content_box
					{
				...
				@media screen and (max-width: 767px) {
					.slider li { 
						...
						background-size: auto ' . $slider_styles["height"][2] . 'px;
						-moz-background-size: auto ' . $slider_styles["height"][2] . 'px;
						-webkit-background-size: auto ' . $slider_styles["height"][2] . 'px;
						-o-background-size: auto ' . $slider_styles["height"][2] . 'px;
					}
					.slider_content_box
					{
				...
				@media screen and (max-width: 479px) {
					.slider li { 
						...
						background-size: auto ' . $slider_styles["height"][3] . 'px;
						-moz-background-size: auto ' . $slider_styles["height"][3] . 'px;
						-webkit-background-size: auto ' . $slider_styles["height"][3] . 'px;
						-o-background-size: auto ' . $slider_styles["height"][3] . 'px;
					}
					.slider_content_box
					{
